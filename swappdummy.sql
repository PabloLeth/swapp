...
-- Tiempo de generación: 07-04-2021 a las 00:17:54
...
(6, 'Raquel', 'huerta', 'raquela@hotmail.com', '$argon2id$v=19$m=65536,t=4,p=1$CMpLe0ijZ+hbEYWP4NKATg$UZO3KkZN8schUm9Pgz17fpSvX0Xcfii1vYeYEu4nC9Y', 654321345, '23322332P', 3, 8, '[\"ROLE_MANAGER\"]'),
(7, 'Belen', 'tolon', 'belen@hotmail.com', '$argon2id$v=19$m=65536,t=4,p=1$CMpLe0ijZ+hbEYWP4NKATg$UZO3KkZN8schUm9Pgz17fpSvX0Xcfii1vYeYEu4nC9Y', 678987654, '44556677Q', 3, 2, 'null'),
